...
| **Android (companion)** | Android **8.0+** (API 26) | arm64, armeabi-v7a | `Smiley-{version}-android-debug.apk` |

> Android is a **companion app only** — it cannot set Discord Rich Presence. Use desktop Smiley for live presence.
