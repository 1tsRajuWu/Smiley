...
[![Windows](https://img.shields.io/badge/Windows-Setup.exe-0078D4?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v4.1.17/Smiley-Setup-4.1.17.exe)
...
[![Linux AppImage](https://img.shields.io/badge/Linux_AppImage-AppImage-FCC624?style=for-the-badge&logo=linux&logoColor=black)](https://github.com/1tsRajuWu/Smiley/releases/download/v4.1.17/Smiley-4.1.17.AppImage)
[![Linux deb](https://img.shields.io/badge/Linux_deb-.deb-E95420?style=for-the-badge&logo=debian&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v4.1.17/Smiley-4.1.17.deb)
<!-- HERO_DOWNLOADS_END -->
...
| Platform | File |
|----------|------|
| Windows | [Smiley-Setup-4.1.17.exe](https://github.com/1tsRajuWu/Smiley/releases/download/v4.1.17/Smiley-Setup-4.1.17.exe) |
...
| Linux (AppImage) | [Smiley-4.1.17.AppImage](https://github.com/1tsRajuWu/Smiley/releases/download/v4.1.17/Smiley-4.1.17.AppImage) |
| Linux (.deb) | [Smiley-4.1.17.deb](https://github.com/1tsRajuWu/Smiley/releases/download/v4.1.17/Smiley-4.1.17.deb) |
<!-- DOWNLOADS_END -->
