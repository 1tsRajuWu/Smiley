...
**Current release: v3.1.1** — pick your platform below, or grab everything from [Releases](https://github.com/1tsRajuWu/Smiley/releases/latest).
...
| | Download | Notes |
|---|----------|-------|
| **Installer** (recommended) | [**Smiley-Setup-3.1.1.exe**](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-Setup-3.1.1.exe) | Windows 10 (1809+) / 11 · Start menu + desktop shortcut |
| **Portable** | [**Smiley-Portable-3.1.1.exe**](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-Portable-3.1.1.exe) | No install — settings in `SmileyData` beside the exe |

[![Download Windows Setup](https://img.shields.io/badge/🪟_Windows-Setup-0078D6?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-Setup-3.1.1.exe)
[![Download Windows Portable](https://img.shields.io/badge/🪟_Portable-1E1E1E?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-Portable-3.1.1.exe)

### 🍎 macOS

| Chip | Download |
|------|----------|
| **Apple Silicon** (M1–M5) | [**Smiley-3.1.1-arm64.dmg**](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-3.1.1-arm64.dmg) |
| **Intel** (pre-2020 Macs) | [**Smiley-3.1.1-x64.dmg**](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-3.1.1-x64.dmg) |

[![Download Mac ARM](https://img.shields.io/badge/🍎_Apple_Silicon-DMG-000000?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-3.1.1-arm64.dmg)
[![Download Mac Intel](https://img.shields.io/badge/🍎_Intel-DMG-555555?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-3.1.1-x64.dmg)
...
|--------|----------|-------|
| **AppImage** | [**Smiley-3.1.1.AppImage**](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-3.1.1.AppImage) | Works on most distros — `chmod +x` then run |
| **.deb** | [**Smiley-3.1.1.deb**](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-3.1.1.deb) | Debian / Ubuntu / Mint |

[![Download Linux AppImage](https://img.shields.io/badge/🐧_AppImage-FCC624?style=for-the-badge&logo=linux&logoColor=black)](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-3.1.1.AppImage)
[![Download Linux deb](https://img.shields.io/badge/🐧_.deb-E95420?style=for-the-badge&logo=ubuntu&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-3.1.1.deb)

### 📱 Android

| Platform | Download | Rich Presence? |
|----------|----------|----------------|
| **Android** | [**Smiley-3.1.1-android-debug.apk**](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-3.1.1-android-debug.apk) | ❌ Companion only — browse, preview GIFs, copy status |
...
[![Download Android APK](https://img.shields.io/badge/🤖_Android-APK-3DDC84?style=for-the-badge&logo=android&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-3.1.1-android-debug.apk)
...
1. Download [**Smiley-Setup-3.1.1.exe**](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-Setup-3.1.1.exe)
2. Run the installer
...
**Portable?** Grab [**Smiley-Portable-3.1.1.exe**](https://github.com/1tsRajuWu/Smiley/releases/download/v3.1.1/Smiley-Portable-3.1.1.exe) and double-click. Settings are stored in a `SmileyData` folder next to the exe. If you don't see the window, check the system tray or use **Settings → Advanced → Reset window position**.
...
```bash
chmod +x Smiley-3.1.1.AppImage
./Smiley-3.1.1.AppImage
```

**Debian / Ubuntu (.deb):**

```bash
sudo dpkg -i Smiley-3.1.1.deb
```
