...
> **Smiley v12 is final** — only bugfix releases (`v12.0.x`) ship from [`Smiley.v12/`](Smiley.v12/). v8 and v7 trees are archived. See [docs/FINAL.md](docs/FINAL.md).

**Smiley v12.0.10** is the current desktop app — native Tauri + Rust. Previous stacks: [legacy/smiley-v8/](legacy/smiley-v8/) (v8), [legacy/electron-v7/](legacy/electron-v7/) (v7.9.x).

---

<details open>
<summary><strong>Smiley v12.0.10 — Direct downloads</strong></summary>

[![Windows](https://img.shields.io/badge/Windows-Setup.exe-0078D4?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v12.0.10/Smiley_12.0.10_x64-setup.exe)
[![macOS Apple Silicon](https://img.shields.io/badge/macOS_Apple_Silicon-Apple_Silicon-555555?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v12.0.10/Smiley_12.0.10_aarch64.dmg)
[![macOS Intel](https://img.shields.io/badge/macOS_Intel-Intel-555555?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v12.0.10/Smiley_12.0.10_x64.dmg)
[![Linux AppImage](https://img.shields.io/badge/Linux_AppImage-AppImage-FCC624?style=for-the-badge&logo=linux&logoColor=black)](https://github.com/1tsRajuWu/Smiley/releases/download/v12.0.10/Smiley_12.0.10_amd64.AppImage)
[![Linux deb](https://img.shields.io/badge/Linux_deb-.deb-E95420?style=for-the-badge&logo=debian&logoColor=white)](https://github.com/1tsRajuWu/Smiley/releases/download/v12.0.10/Smiley_12.0.10_amd64.deb)

| Platform | File |
|----------|------|
| Windows | [Smiley_12.0.10_x64-setup.exe](https://github.com/1tsRajuWu/Smiley/releases/download/v12.0.10/Smiley_12.0.10_x64-setup.exe) |
| macOS Apple Silicon | [Smiley_12.0.10_aarch64.dmg](https://github.com/1tsRajuWu/Smiley/releases/download/v12.0.10/Smiley_12.0.10_aarch64.dmg) |
| macOS Intel | [Smiley_12.0.10_x64.dmg](https://github.com/1tsRajuWu/Smiley/releases/download/v12.0.10/Smiley_12.0.10_x64.dmg) |
| Linux (AppImage) | [Smiley_12.0.10_amd64.AppImage](https://github.com/1tsRajuWu/Smiley/releases/download/v12.0.10/Smiley_12.0.10_amd64.AppImage) |
| Linux (.deb) | [Smiley_12.0.10_amd64.deb](https://github.com/1tsRajuWu/Smiley/releases/download/v12.0.10/Smiley_12.0.10_amd64.deb) |

Release notes: [docs/releases/v12.0.10.md](docs/releases/v12.0.10.md)
