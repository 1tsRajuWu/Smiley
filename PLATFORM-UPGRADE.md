...
**Status (2026-07-09):** **Smiley v8.0.14** is the **shipping** desktop app (Tauri + Rust). Website and README promote v8 only.
...
5. Website + GitHub release **v8.0.14** point end users at native installers.
