...
**Status (2026-07-09):** **Smiley v8.0.19** is the **shipping** desktop app (Tauri + Rust). Website and README promote v8 only.

## Do this in other conversations

1. Prefer **`Smiley.v8/`** for new UI / presence / security work.
2. Repo-root Electron is **archived v7.9.x** under `legacy/electron-v7/` — not advertised to end users; see `legacy/electron-v7/README.md`.
...
5. Website + GitHub release **v8.0.19** point end users at native installers.
6. v8 in-app updates: `docs/RELEASING-V8-SIGNING.md` — `TAURI_SIGNING_PRIVATE_KEY` GitHub secret required for signed `latest.json`.

## Newbie map

[`STRUCTURE.md`](STRUCTURE.md) (repo layout) · [`Smiley.v8/docs/NEWBIE-MAP.md`](Smiley.v8/docs/NEWBIE-MAP.md) · Privacy: `Smiley.v8/docs/PRIVACY-SECURITY.md`
