...
**Status (2026-07-09):** **Smiley v12.0.5** is the **final shipping** desktop app (Tauri + Rust). **Bugfix-only** releases (`v12.0.x`) from [`Smiley.v12/`](Smiley.v12/). This document is **frozen** — do not plan new major versions here.
...
6. Website + GitHub release **v12.0.5** point end users at native installers.
