...
**Status (2026-07-09):** **Smiley v12.0.1** is the **final shipping** desktop app (Tauri + Rust). Website and README promote v12 only.
...
6. Website + GitHub release **v12.0.1** point end users at native installers.
